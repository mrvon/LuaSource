...
# we saved the first answer onto the stack, so now we can just pop it out into %ebx
popl %ebx
...
# PURPOSE
#
# This function is used to compute the value of a number raised to a power.
